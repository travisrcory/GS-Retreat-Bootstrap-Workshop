...
}, 'patched-v3.11.0', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
YUI.add('yui', function (Y, NAME) {}, 'patched-v3.11.0', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
}, 'patched-v3.11.0', {"requires": ["dom-style"]});
...
}, 'patched-v3.11.0', {"requires": ["transition"]});
