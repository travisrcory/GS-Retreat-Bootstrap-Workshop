			...
			<c:when test="<%= portalLicenseState == 6 %>">
				<div class="alert alert-error">
					<c:choose>
						...
						<c:otherwise>
							You have exceeded the developer license connection limit. Click <a href="<%= themeDisplay.getPathMain() %>/portal/license?cmd=resetState&resetToken=<%= com.liferay.portal.license.LicenseManager.getResetToken() %>">here</a> to reset all connections.
						</c:otherwise>
					</c:choose>
				</div>
			</c:when>
...
<h3>Register Your Server or Application</h3>
